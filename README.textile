...
- the *cas-overlay-services-demo* module is a CAS services management webapp built with Maven overlay.
...
To test,
- call the "http://localhost:8080/services":http://localhost:8080/services url to access the CAS services management webapp
...
- cas-overlay-services-demo on http://localhost:8080/services
